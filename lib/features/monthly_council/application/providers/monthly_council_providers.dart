...
final saveMonthlyCouncilProvider =
    FutureProvider.family<bool, List<MonthlyCouncil>>((
      ref,
      monthlyDataList,
    ) async {
...
final getMonthlyCouncilProvider = FutureProvider<List<MonthlyCouncil>>((
  ref,
) async {
  final repo = SupabaseMonthlyCouncilRepo();
  print('Provider: get monthlycouncil()');
  final response = await repo.getMonthlyData();
